 ...
 */
class Unique_Startup_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'unique-startup' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'unique-startup-customize-controls' );
		wp_enqueue_script( 'unique-startup-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Unique_Startup_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
